...
namespace UpuGui
{
    ...
    {
        private const string m_registerContextMenuButtonString = "Register Explorer Context Menu Handler";
        private const string m_unregisterContextMenuButtonString = "Unregister Explorer Context Menu Handler";
